...
digraph SEIQHRF {
  ...
  A->Q[color='yellow']
  A->R[color='blue']
  A->S[color='purple',style='dashed']
  I->P[color='red',style='dashed']
  E->P[color='red',style='dashed']
  A->P[color='red',style='dashed']
  Q->P[color='red',style='dashed']
}
")
```
